...
const GENERATION_PROMPT = [
  ...
  '10. unit "item|slide|screen|page" и quantity используй ТОЛЬКО когда единиц две и больше (например, 2 таблички, 4 постера, 15 слайдов). Единичный носитель — одно меню, одна коробка, одна вывеска — оценивай просто часами, без unit.',
